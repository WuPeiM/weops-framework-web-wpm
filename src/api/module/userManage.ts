...
export default {
    ...
    resetPassword(params = {}) {
        return patch(`${reUrl}/system/mgmt/user_manage/reset_password/`, params)
    },
    /**
     * 新建用户
     *
     ...
     */
    editUser(params = {}) {
        return patch(`${reUrl}/system/mgmt/user_manage/edit_user/`, params)
    },
    /**
     * 设置用户角色
     *
     ...
     */
    setUserRoles(params = {}) {
        return post(`${reUrl}/system/mgmt/user_manage/set_user_roles/`, params)
    },
    /**
     * 双因子认证配置
     *
