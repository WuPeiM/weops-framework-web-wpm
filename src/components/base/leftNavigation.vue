            ...
            <template slot="menu">
                <bk-navigation-menu ref="menu" @select="handleSelect" :default-active="$route.meta.hasOwnProperty('fatherName') ? $route.meta.fatherName : $route.name"
                    ...
                    <bk-navigation-menu-item v-for="item in nav.list" :key="item.name" :has-child="item.children && !!item.children.length"
                        ...
                        <span>{{item.name}}</span>
                        <div slot="child">
                            <bk-navigation-menu-item v-for="child in item.children" :key="child.name" :id="child.id"
...
<script>
    import Header from '@main/components/base/header'
    import Container from '@main/components/base/container'
    import {
    ...
    export default {
        ...
        methods: {
            ...
            confirmUserIdentity() {
                ...
                this.header.list = createAdminRouteConfig()
            },
